...
4. The file has two sections:
  4.1 A main function that detects global and loads all modules. As of writing, this part ends with "[19])(19)"
  4.2 Core-js and regenerator loader, about 3400 lines (use bracket match to find the start/end).

5. Add a blank line after the last babel module, i.e. before the line "}, {}, [19])(19)".

6. Add a blank line before the core-js function, i.e. after  the line "}, {}, [19])(19)".
